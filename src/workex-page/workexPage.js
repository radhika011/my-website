    ...
    <Timeline position="alternate">
      <TimelineItem>
        ...
        <TimelineContent sx={{ py: '12px', px: 2 }}>
          ...
          <Typography>Improving the user interface of an AI diagnostic tool by refactoring plain HTML/CSS/JavaScript into ReactJS components &
                      ...
                      serve the application in other languages and streamlining the ML pipeline to increase efficiency</Typography>
        </TimelineContent>
      </TimelineItem>
      <TimelineItem>
        <TimelineOppositeContent
